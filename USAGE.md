...
| `startLine` | integer | Yes | Start line of code to extract (1-based) |
| `endLine` | integer | Yes | End line of code to extract (1-based) |
...
```json
{
  ...
  "message": "Extracted method 'validateUserInput'"
}
```
...
```json
{
  ...
  "message": "Extracted variable 'taxAmount'"
}
```
...
- Preparing for other refactorings
...
```json
{
  ...
  "changesCount": 3,
  "message": "Inlined variable 'tempUser'"
}
```
...
Moves an element to a different file or package.
...
| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| `file` | string | Yes | Path to the file containing the element |
| `line` | integer | Yes | 1-based line number |
| `column` | integer | Yes | 1-based column number |
| `targetFile` | string | Yes | Destination file path relative to project root |
...
```json
{
  "method": "tools/call",
  "params": {
    "name": "ide_move_element",
    "arguments": {
      "file": "src/main/java/com/example/utils/Helper.java",
      "line": 5,
      "column": 14,
      "targetFile": "src/main/java/com/example/core/Helper.java"
    }
  }
}
```
...
```json
{
  "success": true,
  "newLocation": {
    "file": "src/main/java/com/example/core/Helper.java",
    "line": 5
  },
  "affectedFiles": [
    "src/main/java/com/example/utils/Helper.java",
    "src/main/java/com/example/core/Helper.java",
    "src/main/java/com/example/App.java"
  ],
  "message": "Moved 'Helper' to com.example.core"
}
```
